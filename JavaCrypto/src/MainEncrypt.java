...
public class MainEncrypt {
	...
	public static void main(String[] args) {
		...
		final String PATH_TO_PLAIN_TEXT = "plaintext.txt";
		final String PATH_TO_CONFIGURATION_FILE = "ConfigurationFile.txt";
		...
		new Config().createConfigurationFile("keystore.jks", "keystorealias", String configFilePath, byte[] IV,
