...
public class SignatureHandler {
	...
	public void SignFile(Path cleartextFile) {
		...
		try {
			...
			PrivateKeyEntry entry = (PrivateKeyEntry) Globals.keyStore.getEntry("keystorealias", new KeyStore.PasswordProtection("keystorepassword".toCharArray()));
	...
	public Boolean validateSignature() {
		...
		try {
			...
			PrivateKeyEntry entry = (PrivateKeyEntry) Globals.keyStore.getEntry(Globals.keyStoreAlias, new KeyStore.PasswordProtection("keystorepassword".toCharArray()));
