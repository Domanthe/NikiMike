...
public class KeyManager {
	...
	public void loadKeyStore() {
		try {
			...
			Globals.keyStore.load(new FileInputStream("keystore.jks"), "NikiMike".toCharArray());
		} catch (Exception e) {
	...
	public void encryptSecretKey() {
		try {
			...
			PrivateKeyEntry keys = (PrivateKeyEntry) Globals.keyStore.getEntry("domain", new KeyStore.PasswordProtection("NikiMike".toCharArray()));
